...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=jQ9EFIoL#_wa5fe3rBqxqd9iS3DTYtXO0ufUex99BnYtHhr3SNCQ' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94774331299' : process.env.OWNER_NUMBER,   
ONLY_GROUP: process.env.ONLY_GROUP === undefined ? 'false' : process.env.ONLY_GROUP,
ONLY_ME: process.env.ONLY_ME === undefined ? 'false' : process.env.ONLY_ME,
AUTO_STATUS_READ:  process.env.AUTO_STATUS_READ  || false  ,    
PREFIX: process.env.PREFIX || 'name: Node.js CI
